            ...
            for i,exp_dic in enumerate(exp_dict_list):
                ...
                if loop_counter ==0:
                    if re.match('[Ss]hock [Tt]ube',exp_dict_list[i]['simulation_type']) and re.match('[Ss]pecies[ -][Pp]rofile',exp_dict_list[i]['experiment_type']):
                        ...
                        Y_data_Frame.append('Temperature'+'_'+'experiment'+'_'+str(i))
                        Y_data_Frame.append('Pressure'+'_'+'experiment'+'_'+str(i))                        
                        for variable in range(species_in_simulation):
                            Y_data_Frame.append('X'+'_'+str(variable)+'_'+'experiment'+'_'+str(i))
                        Y_data_Frame.append('TimeShift'+'_'+'experiment'+'_'+str(i)) 
                        ...
                        for value in range(temperatures_in_simulation):
                            Y_data_Frame.append('Temperature'+'_'+str(value)+'_'+'experiment'+'_'+str(i))
                        Y_data_Frame.append('Pressure'+'_'+'experiment'+'_'+str(i))
                        for variable in range(species_in_simulation):
                            Y_data_Frame.append('X'+'_'+str(variable)+'_'+'experiment'+'_'+str(i))
                        Y_data_Frame.append('ResidenceTime'+'_'+'experiment'+'_'+str(i))
                       ...
                       # species_in_simulation = list(exp_dic['conditions_to_run'][0].keys())
                        ...
                        for value in range(pressures_in_simulation):
                            Y_data_Frame.append('Pressure'+'_'+str(value)+'experiment'+'_'+str(i))
                        for variable in range(species_in_simulation):
                            Y_data_Frame.append('X'+'_'+str(variable)+'_'+'experiment'+'_'+str(i))  
                        ...
                        for value in range(temperatures_in_simulation):
                            Y_data_Frame.append('Temperature'+'_'+str(value)+'_'+'experiment'+'_'+str(i))
                        for value in range(pressures_in_simulation):
                            Y_data_Frame.append('Pressure'+'_'+str(value)+'_'+'experiment'+'_'+str(i))
                        ...
                        for x,species in enumerate(exp_dic['simulation'].fullParsedYamlFile['speciesNames']):
                            if species in singular_species and species not in diluent:
                                Y_data_Frame.append('X'+'_'+str(x)+'_'+species+'_'+'experiment'+'_'+str(i))
                            elif species not in singular_species and species not in diluent:
                                for j in range(len(exp_dic['simulation'].fullParsedYamlFile['conditions_to_run'])):
                                    Y_data_Frame.append('X'+'_'+str(x)+'_'+species+'_'+'experiment'+'_'+str(i))    
                        ...
                        for variable in range(time_shift_in_simulation):
                            Y_data_Frame.append('TimeShift'+'_'+str(variable)+'_'+'experiment'+'_'+str(i))
                        
                        for value in range(restimes_in_simulation):
                            Y_data_Frame.append('ResTime'+'_'+str(value)+'_'+'experiment'+'_'+str(i))                        
                    ...
                    if re.match('[Ss]hock [Tt]ube',exp_dict_list[i]['simulation_type']) and re.match('[Ss]pecies[- ][Pp]rofile',exp_dict_list[i]['experiment_type']):
                        ...
                        for variable in range(restime_in_simulation):
                            Y_data_Frame.append('ResidenceTime'+str(variable)+'_'+'experiment'+'_'+str(i))
