...
class Optimization_Utility(object):
    ...
    def looping_over_parsed_yaml_files(self,list_of_parsed_yamls,list_of_yaml_paths,processor=None,kineticSens=1,physicalSens=1,dk=.01, loop_counter=0):
       
        experiment_list = []
        for i,yamlDict in enumerate(list_of_parsed_yamls):
            print('iteration_number:', loop_counter)
